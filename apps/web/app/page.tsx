...
export default function Home() {
  ...
  return <div className='h-screen flex items-center justify-center bg-white'>
    <div className="flex flex-col items-center justify-center gap-5 p-5 bg-gray-100 rounded-lg shadow-lg">
      ...
      <button className="bg-gray-700 rounded px-3 py-1" onClick={()=>{router.push('/signup')}}>Get Start</button>
      <button className="bg-gray-700 rounded px-3 py-1" onClick={()=>{router.push('/login')}}>Sign In</button>
    </div>
  </div>
}