    ...
    style={{
      ...
      <div className="flex w-full bottom-10 left-1/2  -translate-x-1/2 fixed z-50 bg-black ">
        ...
        <div className="flex gap-7 absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 items-center">
            ...
            <div onClick={toggleMic} className="flex self-center items-center justify-center p-2 rounded-full bg-black/30 hover:bg-white/10 text-sm text-white cursor-pointer">{mic ? <MicOffIcon/> : <MicOnIcon/>}</div>
